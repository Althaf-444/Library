...
$finetable = $Borrowed_BooksModel->pendingfine();

?>

<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Pending Fines
    ...
    <div class="row m-3">
        <div class="col-6">
            <div class="d-flex align-items-center m-3">
                ...
                <input type="text" id="searchInput" class="form-control border-0 shadow-none" placeholder="Search pending fine by member id  " aria-label="Search..." />
            </div>
        </div>
        <div class="col-2">
