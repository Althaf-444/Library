...
$finetable = $Borrowed_BooksModel->finetotal();
                ...
                ?>
                        <tr>
                            <?php if ($role == 'admin') : ?>
                                <td>
                                    <div>
                                        <a class="btn btn-sm btn-outline-dark m-2" href="<?= url('views/admin/fine_status.php?id=' . $ft['id'] ?? '') ?>"><i class="bx bx-edit btn-outline-dark"></i></a>
                                    </div>
                                </td>
                            <?php endif; ?>
